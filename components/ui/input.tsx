...
export default function Input({ error = false, className = "", ...props }: InputProps) {
  return (
    <input
      className={[
        "w-full rounded-lg border px-3 py-2.5 text-sm outline-none transition-colors min-h-[44px]",
        ...
        error
          ? "border-red-400 bg-red-50 focus:border-red-400 focus-visible:ring-red-300 placeholder:text-red-300"
